...
Agregar Cliente
   ...
   <asp:PlaceHolder runat="server" ID="editarAgregarContenedor" Visible="false">
      ...
      <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDireccion" ErrorMessage="La dirección es requerida." Display="Dynamic" ForeColor="Red" />
      <br />
      <asp:Label runat="server">Telefono </asp:Label><br />
      <asp:TextBox runat="server" ID="txtTelefono"></asp:TextBox>
      <asp:RequiredFieldValidator runat="server" ControlToValidate="txtTelefono" ErrorMessage="El teléfono es requerido." Display="Dynamic" ForeColor="Red" />
      <br />
      ...
      <br />
      <asp:LinkButton runat="server" ID="btnGuardarCambios" CssClass="btn btn-sm btn-success" OnClick="GuardarCambios_Click" Text="Guardar"></asp:LinkButton>

      <asp:LinkButton runat="server" ID="btnAgregar" CssClass="btn btn-sm btn-success" OnClick="Agregar_Click" Text="Agregar"></asp:LinkButton>

      <asp:LinkButton runat="server" ID="btnVolver" CssClass="btn btn-sm btn-danger ml-2" OnClick="Volver_Click" CausesValidation="false" Text="Volver"></asp:LinkButton>
